...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 border-b border-gray-200 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-6">
            <Link to="/" className="text-sm font-semibold text-gray-600 hover:text-indigo-600 transition-colors">Home</Link>
            <Link to="/products" className="text-sm font-semibold text-gray-600 hover:text-indigo-600 transition-colors">Shop</Link>
            <Link to="/about" className="text-sm font-semibold text-gray-600 hover:text-indigo-600 transition-colors">About</Link>
            ...
            {user ? (
              ...
              <div className="flex items-center gap-4">
                ...
                <Link to="/register" className="px-4 py-2 bg-gray-100 text-sm font-semibold text-gray-800 rounded-lg hover:bg-gray-200">Sign Up</Link>
              </div>
            )}
          </div>
        </div>
