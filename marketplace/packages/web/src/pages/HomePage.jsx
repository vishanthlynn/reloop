    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900">Explore Popular Categories</h2>
            <p className="mt-2 text-lg text-gray-600">Find what you need from our wide selection.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6 text-center">
            {defaultCategories.map((category) => (
              <button
                ...
                className="group flex flex-col items-center p-4 rounded-xl hover:bg-white hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
              >
                <div className="text-5xl mb-3 transition-transform duration-300 group-hover:scale-110">
                  {category.icon}
                </div>
                <p className="text-base font-semibold text-gray-800">{category.name}</p>
              </button>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-10">
            ...
            <h2 className="text-3xl font-extrabold text-gray-900">Freshly Recommended For You</h2>
          </div>
          {loading ? (
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-extrabold text-gray-900">A Marketplace You Can Trust</h2>
            <p className="mt-2 text-lg text-gray-600">We prioritize your safety, security, and satisfaction.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="text-center p-6">
              <div className="w-20 h-20 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center mx-auto mb-5 shadow-inner">
                <Shield className="w-10 h-10" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Buyer Protection</h3>
              <p className="text-gray-600">Shop with confidence. We protect your purchases from click to delivery with our escrow system.</p>
            </div>
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">We ensure our sellers meet high standards, so you can buy with peace of mind.</p>
            </div>
            <div className="text-center p-6">
              <div className="w-20 h-20 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center mx-auto mb-5 shadow-inner">
                <Sparkles className="w-10 h-10" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">AI-Powered Safety</h3>
              <p className="text-gray-600">Our smart technology works 24/7 to detect scams and keep our community safe.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="max-w-4xl mx-auto text-center py-16 px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-extrabold text-gray-900">Ready to Join?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              to="/how-it-works"
              className="inline-block px-10 py-4 bg-gray-200 text-gray-800 rounded-full font-semibold text-lg hover:bg-gray-300 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 transform hover:scale-105"
            >
              Learn How It Works
            </Link>
          </div>
